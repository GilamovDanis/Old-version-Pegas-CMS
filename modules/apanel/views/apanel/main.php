...
<table class="table table-striped table-bordered">
	<tr>
		<td>
		<p><i class="icon-tags"></i> <?php echo HTML::anchor('/apanel/info', 'Общая информация'); ?></p>
		</td>
	</tr>
</table>
...
<table class="table table-striped table-bordered">
	<tr>
		<td>
		<p><i class="icon-tags"></i> <?php echo HTML::anchor('/apanel/config', 'Настройки'); ?></p>
		</td>
	</tr>
</table>
...
<table class="table table-striped table-bordered">
	<tr>
		<td>
		<p><i class="icon-user"></i> <?php echo HTML::anchor('/apanel/user/add', 'Добавить пользователя'); ?></p>
		<p><i class="icon-user"></i> <?php echo HTML::anchor('/apanel/user/', 'Пользователи'); ?></p>
		</td>
	</tr>
</table>
...
<table class="table table-striped table-bordered">
	<tr>
		<td>
		<p><i class="icon-user"></i> <?php echo HTML::anchor('/apanel/courses/', ' Регистрация на курсы'); ?></p>
		<p><i class="icon-user"></i> <?php echo HTML::anchor('/apanel/courses/payments', ' Оплата курсов'); ?></p>
		</td>
	</tr>
</table>
</div>
