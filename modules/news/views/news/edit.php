...
<?php echo Form::open('/news/edit/'.$news->id)?>
<fieldset>
...
<?php echo Form::input('title',$news->title)?> 
<?php echo Form::label('content', 'Введите текст новости') ?> 
<?php echo Form::textarea('content',$news->content)?> <br />
<?php echo Form::submit('save','Редактировать',array('class'=>'btn btn-success'))?>
</fieldset>
<?php echo Form::close()?>
<div class="nav-links">
